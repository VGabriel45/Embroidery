...
def draw_rectangle(width, height, fill_color='2', border_width=2, border_color='1'):
    ...
    # for i in range(len(matrix) - border_width, len(matrix)):
    #     for j in range(len(matrix[i])):
    #         matrix[i][j] = border_color
    # for i in range(border_width, len(matrix) - border_width):
    #     for j in range(border_width):
    #         matrix[i][j] = border_color
    #     for j in range(len(matrix[i]) - border_width, len(matrix[i])):
    #         matrix[i][j] = border_color
